 ...
 */
public class DisclaimersLoader extends BasicLoader<List<Page>> {

    @NonNull private Location mLocation;
    @NonNull private Language mLanguage;

    @Inject
    private DisclaimerResource.Factory pagesFactory;
     ...
     * @param context
     */
    public DisclaimersLoader(Context context, @NonNull Location location, @NonNull Language language, LoadingType loadingType) {
